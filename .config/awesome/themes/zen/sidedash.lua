...
local lock_button = gen_button_with_icon(beautiful.lock_icon)
...
lock_button:connect_signal("button::press", function (c, _, _, button)
	if button == 1 then os.execute("i3lock-fancy-multimonitor -b=0x6") end
end)
